...
$sql2="SELECT name FROM $tbl_name WHERE Username='$myusername' and Pass_1='$mypassword'";
...
$sql="SELECT * FROM $tbl_name WHERE Username='$myusername' and pass_1='$mypassword'";
