...
<html>
	...
	<body>
		<header class="header">
				<a class="codrops-icon codrops-icon--prev" href="user_info.php"></a>
			<h1 class="header__title"><a href="user_home.php">Back to Movie Names <span style="padding-left:21em"></a>
	<?php 
	session_start();
	...
	?></center></h1>
		...
		<div class="container">
			<div class="cube">
				...
				<div class="cube__side cube__side--back">
					<div class="screen">
						<div class="video">
							<video class="video-player" src=<?php echo $row1[0] ?>  preload="auto">
						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									<span class="intro__down">RB cinemas <span class="intro__partial"></span></span>
								</h2>
							</div>
							<div class="intro__side">
				...
				<div class="rows rows--large" >
					<div class="row">
						<div data-seat="A1" class="row__seat" value = "A1"></div>
		...
		<div class="plan">
			...
			<div class="rows rows--mini">
				...
				<div class="row">
					...
					<div class="row__seat tooltip"></div>
					<div class="row__seat row__seat--reserved"></div>
					<div class="row__seat row__seat--reserved"></div>
		...
		<form method="POST" action="saveseats.php">
			...
			<select name="mseats[]" multiple="false" onclick="setMaximumSelected(<?php echo $row2[0] ?>,this)" style="height: 50px;width:240px;-webkit-border-radius: 20px;-moz-border-radius:20px;border-radius:20px;background-color:#eec111;text-indent:105px">
